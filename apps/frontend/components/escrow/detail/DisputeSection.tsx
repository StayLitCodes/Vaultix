  ...
  const fetchTimeline = async () => {
    try {
      ...
      const timelineResponse = await fetch(
        `/api/escrows/${escrowId}/dispute/timeline`,
      );
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-sm font-medium">
                  {dispute.filedBy === publicKey
                    ? "You"
                    : dispute.filedBy.substring(0, 8) + "..."}
                </span>
              </div>
            </div>
            <div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-medium mt-1">
                  {dispute.resolution.resolvedBy === publicKey
                    ? "You"
                    : dispute.resolution.resolvedBy.substring(0, 8) + "..."}
                </p>
              </div>
              {dispute.resolution.splitPercentage && (
                <div className="md:col-span-2">
                  ...
                  <div className="flex gap-4 mt-1">
                    <span className="text-sm font-medium">
                      Buyer: {dispute.resolution.splitPercentage.buyer}%
                    </span>
                    <span className="text-sm font-medium">
                      Seller: {dispute.resolution.splitPercentage.seller}%
                    </span>
                  </div>
                </div>
              )}
        ...
        onResolveDispute && (
          <div className="border-t pt-6">
            <div className="flex justify-end">
              <Button onClick={onResolveDispute}>Resolve Dispute</Button>
            </div>
          </div>
        )}
    </div>
